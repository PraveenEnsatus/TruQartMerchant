...
public class MyImageCache {
     ...
     */
    private MyImageCache(float memCacheSizePercent) {
    ...
    public static MyImageCache getInstance(
        ...
        MyImageCache imageCache = (MyImageCache) mRetainFragment.getObject();

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new MyImageCache(memCacheSizePercent);
