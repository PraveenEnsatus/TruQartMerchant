...
public abstract class ImageLoaderCont {
    ...
    protected ImageLoaderCont(Context context, int imageSize) {
     ...
     * {@link ImageLoaderCont#processBitmap(Object)} to define the processing logic). If the image is
    ...
    /**
     * Adds an {@link MyImageCache} to this image loader.
     *
    ...
    public void addImageCache(FragmentManager fragmentManager, float memCacheSizePercent) {
        mImageCache = MyImageCache.getInstance(fragmentManager, memCacheSizePercent);
    }
     ...
     *            {@link ImageLoaderCont#loadImage(Object, ImageView)}
